  ...
  (0, _createClass3.default)(Walker, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(record, derivatives) {
        var marker, config, name, d, pkgConfig, patches, key, p, dependencies, dependency;
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                if (pkgConfig) {
                  ...
                  if (patches) {
                    for (key in patches) {
                      p = _path2.default.join(marker.base, key);
    ...
    value: function stepDetect(record, derivatives) {
      ...
      try {
        _detector2.default.detect(body, function (node, trying) {
          var dictionary = record.marker.dictionary;
    ...
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(record, derivative) {
        var catcher, stage, newPackage, newMarker, newFile1, failure, isNear, mainNotFound, short, _failure, message, name, dictionary, debug, level;
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 29:
                ...
                if (mainNotFound && newMarker.config) {
                  name = newMarker.config.name.name;

                  message = 'Package.json.main entry not found in ' + name;
                }
                dictionary = record.marker.dictionary;
        ...
        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 10:
                if (!(record.store === _common.STORE_BLOB)) {
                  _context7.next = 19;
                  break;
                }
              ...
              case 15:
                if (!(record.marker.permissive || record.marker.dictionary)) {
                  _context7.next = 19;
                  break;
                }
              ...
              case 22:
                ...
                if (!(record.treatAsBLOB || record.store === _common.STORE_BLOB)) {
                  _context7.next = 29;
                  break;
                }
    ...
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(opts) {
        var marker, input, records, i;
        return _regenerator2.default.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                marker = opts.marker, input = opts.input;
