...
class CommandRegistry {
	 ...
	 * @param {boolean} [options.prefix=false] - Whether or not to register the built-in prefix command
	 ...
	 * @param {boolean} [options.commandState=false] - Whether or not to register the built-in command state commands
